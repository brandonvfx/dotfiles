...
sudo scutil --set ComputerName "morbo"
sudo scutil --set HostName "morbo"
sudo scutil --set LocalHostName "morbo"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "morbo"
